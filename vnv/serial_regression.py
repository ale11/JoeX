...
## \file autotest.py
#  \brief Python script for automated regression testing of Joe examples
...
class testcase:
  ...
  def run_test(self):
    ...
    command_base = "%s %s > outputfile"%(self.joe_exec, self.cfg_file)
...
if __name__=="__main__":
  '''This program runs Joe and ensures that the output matches specified values. This will be used to do nightly checks to make sure nothing is broken. '''
  ...
  plateSA.test_vals = [3.2153e+03, 7.9768e-05]
  ...
  plateEASMkom.test_vals = [6.8602e+04, 3.0080e-02, 2.2523e+07]
